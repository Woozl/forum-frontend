...
export type CreatePostMutation = { __typename?: 'Mutation', createPost: { __typename?: 'Post', title: string, text: string, id: number, points: number, createdAt: string, updatedAt: string } };
...
export type PostQuery = { __typename?: 'Query', post?: { __typename?: 'Post', title: string, text: string, points: number, voteStatus?: number | null, creatorId: number, id: number, createdAt: string, updatedAt: string, creator: { __typename?: 'User', id: number, username: string } } | null };
...
export const RegisterDocument = gql`
    mutation Register($options: UserInputData!) {
...
export const UpdatePostDocument = gql`
    mutation UpdatePost($text: String!, $title: String!, $updatePostId: Int!, $clipLength: Float) {
